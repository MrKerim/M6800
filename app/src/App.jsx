					...
					if (instruction?.type !== undefined) {
						if (instruction.type === "immediate") {
							...
							if (labelVal < 0x100) {
								...
								tempMemory[PCindex] = parseInt(
									labelVal.toString(16).padStart(4, "0").slice(0, 2),
									16
								);
								tempMemory[PCindex + 1] = parsInt(
									labelVal.toString(16).padStart(4, "0").slice(2, 4),
									16
								);
							}
